  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-200 py-12">
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h1 className="text-5xl font-extrabold text-blue-800 mb-4">Descubre los mejores Bootcamps</h1>
        <p className="text-lg text-blue-700 mb-6">
          Encuentra el bootcamp perfecto para impulsar tu carrera como desarrollador.
        </p>
      </div>
